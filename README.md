This `GitHub` repository contains the code used for the PhD thesis 'Investigating sex-specific responses in exercise-induced mitochondrial biogenesis within human skeletal muscle' by Dale Taylor.
